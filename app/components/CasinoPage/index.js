...
export default function CasinoPage({ isOpen, handleClose, data }) {
        ...
        <Box sx={style}>
          <div className="bg-white h-[98vh] overflow-y-auto hide-scrollbar">
            <div className="flex items-center gap-5 bg-[#1E8067] p-2">
              ...
              <h1 className="  text-18  text-white">{data?.title}</h1>
            </div>
            <div className="h-full w-full">
              <iframe
                src={`https://aura.fawk.app/${userToken}/9804/${data?.launchId}`}
